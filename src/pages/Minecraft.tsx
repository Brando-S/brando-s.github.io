...
export default function Minecraft() {
    ...
    return <>
        ...
        <p>
            I worked on several popular Minecraft servers as a Software Engineer for many years early in my career. Minecraft was a fantastic learning
        ...
        <p>
            Minecraft offers multiplayer servers where players can play together.
            Quickly the community started to modify the play experience using server-sided mods called plugins which allowed developers to make completely new gameplay experiences and essentially turned Minecraft into a game engine.
        </p>
        <p>
