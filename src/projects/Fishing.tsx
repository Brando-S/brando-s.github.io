...
export function FishingProject() {
    ...
    {`public performItemAnimation(receivingPlayer: SPlayer, location: Vector3, items: ItemStack[]): void {
        ...
        items.forEach(stack => {
            ...
            Starlight is built using the <a href="https://github.com/rbxts-flamework/core">Flamework</a> which has services and controllers which run on the server and client respectively.
